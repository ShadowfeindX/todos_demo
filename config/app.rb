...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'todos-demo.com'
  config.app_name = 'Todos_demo'
  config.mailer.from = 'Todos_demo <no-reply@todos-demo.com>'
  ...
  #
  config.app_secret = '0HoFJJvgaSRTflrY5f7nAxfi6Q_y0Jzt3eaPsQhE24TV7gzjpI7J2T3ELQMjHzDM3Yo'
